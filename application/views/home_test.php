...
<body id="body" class="up-scroll">
				...
				<div class="col-sm-4" style="display: flex;align-items: center;">
					<div class="card">
						...
						<div class="card-body widget-content">
							<span class="widget-content-title">4,103</span>
	...
	<hr>
		...
		<div class="row pb-4">
			...
			?>
					<div class="col-md-3 mb-6 overlay">
						<section>
							<div class="card1">
								<div class="view view-cascade ">
									<img style="border-top-left-radius: 5px; border-top-right-radius: 5px;" src="<?php echo base_url() . 'files/program_image/' . $p->program_imge; ?>" class="card-img-top" alt="">
									<a>
										<div class="mask rgba-white-slight"></div>
									</a>
								</div>
								<div class="card-body card-body-cascade text-center">
									<h4 class="h6"><strong> <?php echo $p->program_name; ?> </strong></h4>
									<h4 class="h6"><strong>กลุ่มลงทะเบียน <?php echo $p->program_room; ?> </strong></h4>
									<h5 class="h6">จำนวนที่นั่งคงเหลือ <h5>
											<strong>
												<?php
												$pm = $p->program_max;
												$pc1 = $p->program_count;
												if ($pc1 == 0 || $pc1 == '') {
													$pc1 = '0';
												?>
													<h6 style="color: green;"><?php echo $pc1 . '/' .  $pm; ?></h6>
												<?php
												} elseif ($pc1 < $pm) {
													$pc1 = $p->program_count;
												?>
												...
												<?php
													...
													$pc1 = $p->program_count;
												?>
													<h6 style="color: red;"><?php echo $pc1 . '/' .  $pm; ?></h6>
												<?php
												}
												?>
											</strong></h6>
										...
										?>
												<a class="btn btn-blue-grey disabled">
													<strong class="h2" style="font-size:100%; color:white"> หมดเขตลงทะเบียน</strong>
													<?php
												} else {

													if ($pc < $pm) {
													?>
														<a class="btn btn-orange btn-rounded waves-effect waves-light">
															<strong class="h2" style="font-size:100% ; color:white" onclick="program_regis(<?php echo $p->program_open_id; ?>)"> ลงทะเบียนอบรม</strong>
														<?php
													}
													if ($pc >= $pm) {
														?>
															<a class="btn btn-blue-grey disabled">
																<strong class="h2" style="font-size:100%; color:white"> ที่นั่งเต็ม</strong>
														<?php
													}
												}
											} else {
														?>
														<a class="btn btn-blue-grey disabled">
															<strong class="h2" style="font-size:100%; color:white"> ยังไม่เปิดให้บริการ</strong>
														<?php
													}
														?>
														</a>
														<h5 class="h6"> <?php
																		$pd = date("Y-m-d");
																		if ($pd == $p->program_date) {
																			echo '<h6 class="h6" style="color: red;">หมดเขตวันนี้</h6>';
																		} elseif ($pd > $p->program_date) {
																			echo '<h6 class="h6" style="color: red;">หมดเขตลงทะเบียน</h6>';
																		} else {
																			$date = $p->program_date;
																			echo '<h6 class="h6">หมดเขต&nbsp;' . DateThaiNotTime($date) . '<h6>';
																		}
																		?>
															<h5>
								</div>
