    ...
    <body>
        ...
        <div class="container-fluid wow fadeIn" style="background-color: #F7F7F7;">
            <nav class="bg-transparent breadcrumb breadcrumb-2 px-0 mb-2" aria-label="breadcrumb">
                <strong>
                    <h2 class="h2" style="color: #323232; font-size:16pt;">ผู้ใช้ที่กรอกคะแนนแล้ว</h2>
                </strong>
            ...
            <div>
                <a href="<?php echo base_url() . 'exam/exam_enter_score' ?> "><button type="button" class="btn btn-success" style="font-size: 11pt;">
            ...
            <table id="myTable" class="table " cellspacing="0" style=" box-shadow: 0 0px 10px rgba(0, 0, 0, .08), 0 0 6px rgba(0, 0, 0, .05);">
                <thead>
                    <tr align="center">
                        <th style="color: #323232; font-weight: bold;"><h6 class="h6">ลำดับ</h6></th>
                        ...
                        <th style="color: #323232; font-weight: bold;">คะแนนที่ได้</th>
                        <th style="color: #323232; font-weight: bold;">สถานะสอบ</th>
                        <th style="color: #323232; font-weight: bold;width:8%;">จัดการ</th>
                    </tr>
                </thead>
                <tbody>
                    <?php
                    foreach ($exam_score_success as $exa) {
                    ?>
                        <tr>
                            ...
                            <td style="text-align: center;">
                                <?php
                                $score = $exa->exam_member_score;
                                if ($score >= 700){
                                    echo $score;
                                }elseif ($score == 'not_exam'){
                                    echo $score;
                                }else{
                                    echo $score;
                                }
                            ...
                            <td style="text-align: center;">
                                ...
                                if ($score >= 700){
                                    ?>
                                    <h6 class="" style="color: #00CE48;">ผ่าน</h6>
                                    <?php
                                }elseif ($score == 'not_exam'){
                                    ?>
                                    <h6 class="" style="color:red;">ไม่เข้าสอบ</h6>
                                    <?php
                                }else{
                                    ?>
                                    <h6 class="" style="color:red;">ไม่ผ่าน</h6>
                                    <?php
                                }
                                ?>
                            </td>
                            <td style="text-align: center; ">
                                    ...
                                    <div class="row mt-18">
                                            ...
                                            <button type="button" class="btn btn-danger"  onclick="canExam_member_success(<?php echo $exa->exam_member_id; ?>,this)" >ยกเลิก</button>
                                        </div>
                                    </div>
                            </td>
                        </tr>
