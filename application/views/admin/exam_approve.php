    ...
    <body>
        ...
        <div class="container-fluid wow fadeIn" style="background-color: #F7F7F7;">
            <nav class="bg-transparent breadcrumb breadcrumb-2 px-0 mb-2" aria-label="breadcrumb">
                <strong>
                    <h2 class="h2" style="color: #323232; font-size:16pt;">กำหนดชุดข้อสอบ</h2>
                </strong>
                <ul class="list-unstyled d-flex p-1 m-1">
                    <li class="breadcrumb-item"><a href="<?php echo base_url() . 'home'; ?>">Home</a></li>
                    <li class="breadcrumb-item"><a href="<?php echo base_url() . 'dashboard'; ?>">Dashboard</a></li>
                    <li class="breadcrumb-item active" aria-current="page">กำหนดชุดข้อสอบ</li>
                </ul>
            </nav>
            <div>
                <a href="<?php echo base_url() . 'exam/exam_define' ?> "><button type="button" class="btn btn-success" style="font-size: 11pt;">
