    ...
    <body>
        ...
        <div class="container-fluid wow fadeIn" style="background-color: #F7F7F7;">
            <nav class="bg-transparent breadcrumb breadcrumb-2 px-0 mb-2" aria-label="breadcrumb">
                <strong>
                    <h2 class="h2" style="color: #323232; font-size:16pt;">ผู้ใช้ที่กำหนดชุดข้อสอบแล้ว</h2>
                </strong>
                <ul class="list-unstyled d-flex p-1 m-1">
                    <li class="breadcrumb-item"><a href="<?php echo base_url() . 'home'; ?>">Home</a></li>
                    <li class="breadcrumb-item"><a href="<?php echo base_url() . 'dashboard'; ?>">Dashboard</a></li>
                    <li class="breadcrumb-item active" aria-current="page">ผู้ใช้ที่กำหนดชุดข้อสอบแล้ว</li>
                </ul>
            </nav>
            <div>
                <a href="<?php echo base_url() . 'exam/exam_approve' ?> "><button type="button" class="btn btn-success" style="font-size: 11pt;">
                    ...
                    ?>
                        <tr>
                            ...
                            <td align="center">
                                ...
                                <div class="row mt-3">
                                    <select class="form-control" id="exam_archive" name="exam_archive" style="max-width:60%;">
